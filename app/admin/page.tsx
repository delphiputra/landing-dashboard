    ...
    <div className="p-6 bg-gradient-to-r from-yellow-50 via-white to-yellow-50">
      ...
      <main className="flex-grow p-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="relative">
              <Link href="/pembeli/order">
                <button className="p-2 bg-orange-900 text-white rounded-full hover:bg-orange-950">
            ...
            {makanan.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  className="mt-6 w-full px-4 py-2 bg-yellow-700 text-white rounded hover:bg-yellow-800 transition"
                >
                  Order Now
                </button>
              </div>
          ...
          <h2 className="text-3xl font-extrabold text-center mb-4 text-gray-800 mt-10">
            Minuman Menu 🍹
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {minuman.map((item) => (
